...
public class Populator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Artist artist1 = artistRepo.save(new Artist("Nirvana","nirvanaBand img", rating1, comment1));
		Album album1 = albumRepo.save(new Album("Nevermind", "albumNevermind.img", "DGC", artist1, rating1, comment3, tag1));
		Song song1 = songRepo.save(new Song("Lithium", "https://www.youtube.com/watch?v=pkcJEvMcnEg", "4:16", artist1, album1, rating1, comment1));	
		Song song2 = songRepo.save(new Song("Heart Shaped Box", "https://www.youtube.com/watch?v=n6P0SitRwy8", "4:45", artist1, album1, rating1, comment2));	
		...
		Song song3 = songRepo.save(new Song("Down In It", "https://www.youtube.com/watch?v=NkphW38WyYo", "4:37", artist2, album2, rating1, comment1));	
		Song song4 = songRepo.save(new Song("Head Like A Hole", "https://www.youtube.com/watch?v=nOVW938sr0k", "5:00", artist2, album2, rating1, comment1));
		...
		Song song5 = songRepo.save(new Song("Santeria", "https://www.youtube.com/watch?v=k3ZeUL4fRyko", "3:04", artist3, album3, rating1, comment1));	
		Song song6 = songRepo.save(new Song("What I got", "https://www.youtube.com/watch?v=0Uc3ZrmhDN4", "2:53", artist3, album3, rating1, comment1));
	}
}
